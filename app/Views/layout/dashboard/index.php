...
<body id="page-top">
    ...
    <script src="<?= base_url() ?>/src/js/moment.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#example').DataTable({
                ...
                // Menerapkan logika pencarian berdasarkan tanggal menggunakan jQuery
                initComplete: function() {
                    ...
                    $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                        var tgl_laporan = data[1];
                        var startDateMoment = moment(startDate, 'YYYY-MM-DD').startOf('day');
                        var endDateMoment = moment(endDate, 'YYYY-MM-DD').endOf('day');
                        var laporanMoment = moment(tgl_laporan, 'YYYY-MM-DD');

                        if (startDate && endDate) {
                            return laporanMoment.isBetween(startDateMoment, endDateMoment, null, '[]');
                        }
