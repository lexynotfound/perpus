...
<ol class="breadcrumb nav nav-tabs">
    ...
    <li class="nav-item nav-link"><a class="nav-link" href="<?= base_url('kategori'); ?>"><i class="fas fa-regular fa-list"></i></i>&nbsp; Kategori Buku</a></li>
    <li class="nav-item nav-link active"><a class="nav-link" href="<?= base_url('kategori/createkt') ?>"><i class="fas fa-solid fa-book-medical"></i></i>&nbsp; Tambah Kategori Baru</a></li>
</ol>
                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <?php endif; ?>
                            <h2 class="text-uppercase text-center mb-5">Penambahan Data Kategori Buku</h2>
                            <form action="/kategori/add" method="post">
                                <?= csrf_field() ?>
                                <div class="form-outline mb-4">
                                    <input type="text" id="form3Example1cg" class="form-control form-control-lg" name="nama_kategori" required />
