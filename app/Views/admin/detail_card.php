...
<head>
    ...
    <link rel="stylesheet" href="public/src/css/bootstrap.css">
    <link rel="stylesheet" href="public/src/css/mystyle.css">
    ...
    <script src="/src/js/dropdown-hoover.js"></script>
...
*/
        ...
        .navbar {
            ...
            --bs-navbar-color: rgba(7, 148, 236, 0.55);
            --bs-navbar-colors: rgba(255, 255, 255);
        ...
        .navbar-toggler {
            ...
            line-height: 1;
            color: var(--bs-navbar-colors);
            background-color: transparent;
            border: var(--bs-border-width) solid var(--bs-navbar-toggler-border-colors);
  ...
  "stringMap":[ {
    ...
    "replace" : "next"
        ...
        .rounded-image {
            ...
            border-radius: 1px;
            /* Sesuaikan nilai border-radius sesuai dengan ukuran kotak yang diinginkan */
        }
    </style>
</head>
                    ...
                    <div class="col col-lg-6 mb-4 mb-lg-0">
                        ...
                        <div class="card mb-3" style="border-radius: .5rem;">
                            <div class="row g-0">
                                ...
                                background-color: rgba(var(--bs-info-rgb), var(--bs-bg-opacity)) !important;">
                                    <img src="public/img/<?= $user->foto; ?>" alt="Avatar" class="img-fluid my-5" style="width: 90px;" />
                                    <h5><?= $user->nama; ?></h5>
                                    <h6><?= $user->jenkel; ?></h6>
