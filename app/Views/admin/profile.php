        ...
        <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="<?= base_url('/img/' . user()->foto); ?>" alt="Admin" class="rounded-circle" width="150">
                            <div class="mt-3">
                                <h4><?= user()->nama; ?></h4>
                                <p class="text-secondary  font-size-xl mb-1">
                                    <span class="badge bg-<?= ($users->name == 'petugas') ? 'info' : 'dark'; ?> ">
                                        <?= $users->name; ?>
                                    </span>
                                </p>
                            </div>
                ...
                <div class="card mt-3">
                    ...
                    <a class="btn btn-outline-primary mb-2" href="<?= base_url('admin'); ?>">Kembali</a>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <?= date('Y-m-d', strtotime(user()->tgl_lahir)); ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <a class="btn btn-info " target="__blank" href="<?= base_url('admin/editProfileViews') ?>">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
