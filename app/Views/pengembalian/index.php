...
<section class="content-header">
    ...
    <ol class="breadcrumb nav nav-tabs">
        ...
        <li class="nav-item nav-link active"><a class="nav-link" href="<?= base_url('pengembalian'); ?>"><i class="fas fa-solid fa-book"></i>&nbsp; Daftar Data Pengembalian</a></li>
    </ol>
</section>
<table id="example" class="table table-striped" style="width:100%">
    ...
    <tbody>
        <?php $no = 1;
        foreach ($pengembalian as $pj) { ?>
            <tr>
                <td><?= $no; ?></td>
                <td><?= $pj->id_pengembalian; ?></td>
                <td><?= $pj->anggota; ?></td>
                <td><?= $pj->id_buku; ?></td>
                <td><?= $pj->title; ?></td>
                <td>
                ...
                <td><?= $pj->denda; ?></td>
                <td style="width:20%;">
                    <span class="badge bg-<?= ($pj->status == 'Di Pinjam') ? 'warning' : 'dark'; ?>">
